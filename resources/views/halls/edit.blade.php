         ...
         <div class="row">
            ...
            <div class="col-xs-12 col-sm-12 col-md-12">
                <div class="form-group">
                    ...
                    <input type="text" name="lecture_hall_name" value="{{ $hall->name }}" class="form-control" placeholder="Lecture Hall Name">
                </div>
            </div>
            <div class="col-xs-12 col-sm-12 col-md-12">
                <div class="form-group">
                    <strong>Lecture Hall Place:</strong>
                    <input type="text" name="lecture_hall_place" value="{{ $hall->name }}" class="form-control" placeholder="Lecture Hall Place">
                </div>
            </div>
